# Comparing `tmp/tire_code_parser-0.2.0.tar.gz` & `tmp/tire-code-parser-0.8.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "tire_code_parser-0.2.0.tar", last modified: Mon Mar 18 16:09:02 2024, max compression
+gzip compressed data, was "tire-code-parser-0.8.0.tar", last modified: Sat Apr 20 18:02:24 2024, max compression
```

## Comparing `tire_code_parser-0.2.0.tar` & `tire-code-parser-0.8.0.tar`

### file list

```diff
@@ -1,11 +1,15 @@
-drwxrwxrwx   0        0        0        0 2024-03-18 16:09:02.610672 tire_code_parser-0.2.0/
--rw-rw-rw-   0        0        0     1090 2024-03-18 15:02:29.000000 tire_code_parser-0.2.0/LICENSE
--rw-rw-rw-   0        0        0      372 2024-03-18 16:09:02.609671 tire_code_parser-0.2.0/PKG-INFO
--rw-rw-rw-   0        0        0       95 2024-03-18 16:01:52.000000 tire_code_parser-0.2.0/README.md
--rw-rw-rw-   0        0        0       42 2024-03-18 16:09:02.610672 tire_code_parser-0.2.0/setup.cfg
--rw-rw-rw-   0        0        0      500 2024-03-18 16:08:46.000000 tire_code_parser-0.2.0/setup.py
-drwxrwxrwx   0        0        0        0 2024-03-18 16:09:02.608669 tire_code_parser-0.2.0/tire_code_parser.egg-info/
--rw-rw-rw-   0        0        0      372 2024-03-18 16:09:02.000000 tire_code_parser-0.2.0/tire_code_parser.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0      186 2024-03-18 16:09:02.000000 tire_code_parser-0.2.0/tire_code_parser.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2024-03-18 16:09:02.000000 tire_code_parser-0.2.0/tire_code_parser.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0        1 2024-03-18 16:09:02.000000 tire_code_parser-0.2.0/tire_code_parser.egg-info/top_level.txt
...
### Comparing `tire_code_parser-0.2.0/LICENSE` & `tire-code-parser-0.8.0/LICENSE`
