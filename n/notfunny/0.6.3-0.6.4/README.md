# Comparing `tmp/notfunny-0.6.3.tar.gz` & `tmp/notfunny-0.6.4.tar.gz`
...
## Comparing `notfunny-0.6.3.tar` & `notfunny-0.6.4.tar`
...
### Comparing `notfunny-0.6.3/setup.py` & `notfunny-0.6.4/setup.py`
