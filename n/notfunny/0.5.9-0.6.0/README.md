# Comparing `tmp/notfunny-0.5.9.tar.gz` & `tmp/notfunny-0.6.0.tar.gz`
...
## Comparing `notfunny-0.5.9.tar` & `notfunny-0.6.0.tar`
...
### Comparing `notfunny-0.5.9/PKG-INFO` & `notfunny-0.6.0/PKG-INFO`
...
### Comparing `notfunny-0.5.9/notfunny.egg-info/PKG-INFO` & `notfunny-0.6.0/notfunny.egg-info/PKG-INFO`
...
### Comparing `notfunny-0.5.9/setup.py` & `notfunny-0.6.0/setup.py`
