# Comparing `tmp/napari_findaureus-0.0.2.tar.gz` & `tmp/napari_findaureus-0.0.3.tar.gz`
...
### Comparing `napari_findaureus-0.0.2/src/findaureus/_widget.py` & `napari_findaureus-0.0.3/src/findaureus/_widget.py`
