# Comparing `tmp/pyrealsense2-2.56.0.6483-cp39-cp39-win_amd64.whl.zip` & `tmp/pyrealsense2-2.9.1-cp36-cp36m-win_amd64.whl.zip`

## zipinfo {}

```diff
@@ -1,16 +1,18 @@
-Zip file size: 4015704 bytes, number of entries: 14
--rw-rw-rw-  2.0 fat       87 b- defN 24-Apr-20 20:44 pyrealsense2/__init__.py
--rw-rw-rw-  2.0 fat       28 b- defN 24-Apr-20 20:44 pyrealsense2/_version.py
--rw-rw-rw-  2.0 fat 11925504 b- defN 24-Apr-20 20:44 pyrealsense2/pyrealsense2.cp39-win_amd64.pyd
--rw-rw-rw-  2.0 fat  1823232 b- defN 24-Apr-20 20:44 pyrealsense2/pyrsutils.cp39-win_amd64.pyd
--rw-rw-rw-  2.0 fat     3726 b- defN 24-Apr-20 20:29 pyrealsense2-2.56.0.6483.data/scripts/align-depth2color.py
--rw-rw-rw-  2.0 fat     1671 b- defN 24-Apr-20 20:29 pyrealsense2-2.56.0.6483.data/scripts/export_ply_example.py
--rw-rw-rw-  2.0 fat     2563 b- defN 24-Apr-20 20:29 pyrealsense2-2.56.0.6483.data/scripts/opencv_viewer_example.py
--rw-rw-rw-  2.0 fat     4427 b- defN 24-Apr-20 20:29 pyrealsense2-2.56.0.6483.data/scripts/python-rs400-advanced-mode-example.py
--rw-rw-rw-  2.0 fat     1980 b- defN 24-Apr-20 20:29 pyrealsense2-2.56.0.6483.data/scripts/python-tutorial-1-depth.py
--rw-rw-rw-  2.0 fat    11554 b- defN 24-Apr-20 20:44 pyrealsense2-2.56.0.6483.dist-info/LICENSE
--rw-rw-rw-  2.0 fat     1898 b- defN 24-Apr-20 20:44 pyrealsense2-2.56.0.6483.dist-info/METADATA
--rw-rw-rw-  2.0 fat      100 b- defN 24-Apr-20 20:44 pyrealsense2-2.56.0.6483.dist-info/WHEEL
--rw-rw-rw-  2.0 fat       13 b- defN 24-Apr-20 20:44 pyrealsense2-2.56.0.6483.dist-info/top_level.txt
-?rw-rw-r--  2.0 fat     1410 b- defN 24-Apr-20 20:44 pyrealsense2-2.56.0.6483.dist-info/RECORD
-14 files, 13778193 bytes uncompressed, 4013288 bytes compressed:  70.9%
...
-Filename: pyrealsense2-2.56.0.6483.data/scripts/align-depth2color.py
+Filename: pyrealsense2/realsense2.dll
 Comment: 
 
-Filename: pyrealsense2-2.56.0.6483.data/scripts/export_ply_example.py
+Filename: pyrealsense2-2.9.1.data/scripts/align-depth2color.py
 Comment: 
 
-Filename: pyrealsense2-2.56.0.6483.data/scripts/opencv_viewer_example.py
+Filename: pyrealsense2-2.9.1.data/scripts/export_ply_example.py
 Comment: 
 
-Filename: pyrealsense2-2.56.0.6483.data/scripts/python-rs400-advanced-mode-example.py
+Filename: pyrealsense2-2.9.1.data/scripts/opencv_viewer_example.py
 Comment: 
 
-Filename: pyrealsense2-2.56.0.6483.data/scripts/python-tutorial-1-depth.py
+Filename: pyrealsense2-2.9.1.data/scripts/python-rs400-advanced-mode-example.py
 Comment: 
 
-Filename: pyrealsense2-2.56.0.6483.dist-info/LICENSE
+Filename: pyrealsense2-2.9.1.data/scripts/python-tutorial-1-depth.py
 Comment: 
 
-Filename: pyrealsense2-2.56.0.6483.dist-info/METADATA
+Filename: pyrealsense2-2.9.1.dist-info/DESCRIPTION.rst
 Comment: 
 
-Filename: pyrealsense2-2.56.0.6483.dist-info/WHEEL
+Filename: pyrealsense2-2.9.1.dist-info/metadata.json
 Comment: 
 
-Filename: pyrealsense2-2.56.0.6483.dist-info/top_level.txt
+Filename: pyrealsense2-2.9.1.dist-info/top_level.txt
 Comment: 
 
-Filename: pyrealsense2-2.56.0.6483.dist-info/RECORD
...
```diff
@@ -1 +1 @@
-__version__ = "2.56.0.6483"
+__version__ = "2.9.1"
```

## Comparing `pyrealsense2-2.56.0.6483.data/scripts/python-rs400-advanced-mode-example.py` & `pyrealsense2-2.9.1.data/scripts/python-rs400-advanced-mode-example.py`
...
## Comparing `pyrealsense2-2.56.0.6483.data/scripts/python-tutorial-1-depth.py` & `pyrealsense2-2.9.1.data/scripts/python-tutorial-1-depth.py`
...
## Comparing `pyrealsense2-2.56.0.6483.dist-info/METADATA` & `pyrealsense2-2.9.1.dist-info/METADATA`
