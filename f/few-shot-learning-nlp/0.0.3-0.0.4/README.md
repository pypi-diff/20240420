# Comparing `tmp/few_shot_learning_nlp-0.0.3.tar.gz` & `tmp/few_shot_learning_nlp-0.0.4.tar.gz`
...
## Comparing `few_shot_learning_nlp-0.0.3.tar` & `few_shot_learning_nlp-0.0.4.tar`
...
### Comparing `few_shot_learning_nlp-0.0.3/LICENSE` & `few_shot_learning_nlp-0.0.4/LICENSE`

 * *Files identical despite different names*

### Comparing `few_shot_learning_nlp-0.0.3/setup.py` & `few_shot_learning_nlp-0.0.4/setup.py`
