# Comparing `tmp/fgo_api_types-2024.4.20.2.41.4.tar.gz` & `tmp/fgo_api_types-2024.4.6.2.22.3.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "fgo_api_types-2024.4.20.2.41.4.tar", max compression
+gzip compressed data, was "fgo_api_types-2024.4.6.2.22.3.tar", max compression
```

## Comparing `fgo_api_types-2024.4.20.2.41.4.tar` & `fgo_api_types-2024.4.6.2.22.3.tar`

### file list

```diff
@@ -1,14 +1,14 @@
--rw-r--r--   0        0        0    34523 2024-04-20 02:40:48.792351 fgo_api_types-2024.4.20.2.41.4/LICENSE
--rw-r--r--   0        0        0      449 2024-04-20 02:40:48.792351 fgo_api_types-2024.4.20.2.41.4/README.md
--rw-r--r--   0        0        0        0 2024-04-20 02:41:04.652325 fgo_api_types-2024.4.20.2.41.4/fgo_api_types/__init__.py
--rw-r--r--   0        0        0      434 2024-04-20 02:41:04.652325 fgo_api_types-2024.4.20.2.41.4/fgo_api_types/base.py
--rw-r--r--   0        0        0     4368 2024-04-20 02:41:04.652325 fgo_api_types-2024.4.20.2.41.4/fgo_api_types/basic.py
--rw-r--r--   0        0        0     3762 2024-04-20 02:41:04.652325 fgo_api_types-2024.4.20.2.41.4/fgo_api_types/common.py
--rw-r--r--   0        0        0    40935 2024-04-20 02:41:04.652325 fgo_api_types-2024.4.20.2.41.4/fgo_api_types/enums.py
--rw-r--r--   0        0        0   177949 2024-04-20 02:41:04.652325 fgo_api_types-2024.4.20.2.41.4/fgo_api_types/gameenums.py
--rw-r--r--   0        0        0    85844 2024-04-20 02:41:04.652325 fgo_api_types-2024.4.20.2.41.4/fgo_api_types/nice.py
--rw-r--r--   0        0        0    59051 2024-04-20 02:41:04.656325 fgo_api_types-2024.4.20.2.41.4/fgo_api_types/raw.py
--rw-r--r--   0        0        0     4518 2024-04-20 02:41:04.656325 fgo_api_types-2024.4.20.2.41.4/fgo_api_types/rayshift.py
--rw-r--r--   0        0        0    19285 2024-04-20 02:41:04.656325 fgo_api_types-2024.4.20.2.41.4/fgo_api_types/search.py
--rw-r--r--   0        0        0      520 2024-04-20 02:41:04.968324 fgo_api_types-2024.4.20.2.41.4/pyproject.toml
--rw-r--r--   0        0        0     1272 1970-01-01 00:00:00.000000 fgo_api_types-2024.4.20.2.41.4/PKG-INFO
...
### Comparing `fgo_api_types-2024.4.20.2.41.4/LICENSE` & `fgo_api_types-2024.4.6.2.22.3/LICENSE`

 * *Files identical despite different names*

### Comparing `fgo_api_types-2024.4.20.2.41.4/fgo_api_types/basic.py` & `fgo_api_types-2024.4.6.2.22.3/fgo_api_types/basic.py`

 * *Files identical despite different names*

### Comparing `fgo_api_types-2024.4.20.2.41.4/fgo_api_types/common.py` & `fgo_api_types-2024.4.6.2.22.3/fgo_api_types/common.py`

 * *Files identical despite different names*

### Comparing `fgo_api_types-2024.4.20.2.41.4/fgo_api_types/enums.py` & `fgo_api_types-2024.4.6.2.22.3/fgo_api_types/enums.py`
...
### Comparing `fgo_api_types-2024.4.20.2.41.4/fgo_api_types/gameenums.py` & `fgo_api_types-2024.4.6.2.22.3/fgo_api_types/gameenums.py`
...
### Comparing `fgo_api_types-2024.4.20.2.41.4/fgo_api_types/nice.py` & `fgo_api_types-2024.4.6.2.22.3/fgo_api_types/nice.py`
...
### Comparing `fgo_api_types-2024.4.20.2.41.4/fgo_api_types/raw.py` & `fgo_api_types-2024.4.6.2.22.3/fgo_api_types/raw.py`

 * *Files identical despite different names*

### Comparing `fgo_api_types-2024.4.20.2.41.4/fgo_api_types/rayshift.py` & `fgo_api_types-2024.4.6.2.22.3/fgo_api_types/rayshift.py`

 * *Files identical despite different names*

### Comparing `fgo_api_types-2024.4.20.2.41.4/fgo_api_types/search.py` & `fgo_api_types-2024.4.6.2.22.3/fgo_api_types/search.py`

 * *Files identical despite different names*

### Comparing `fgo_api_types-2024.4.20.2.41.4/pyproject.toml` & `fgo_api_types-2024.4.6.2.22.3/pyproject.toml`
...
### Comparing `fgo_api_types-2024.4.20.2.41.4/PKG-INFO` & `fgo_api_types-2024.4.6.2.22.3/PKG-INFO`
