# Comparing `tmp/flechemano-0.5.tar.gz` & `tmp/flechemano-0.6.tar.gz`
...
## Comparing `flechemano-0.5.tar` & `flechemano-0.6.tar`
...
### Comparing `flechemano-0.5/PKG-INFO` & `flechemano-0.6/PKG-INFO`
...
### Comparing `flechemano-0.5/flechemano.egg-info/PKG-INFO` & `flechemano-0.6/flechemano.egg-info/PKG-INFO`
