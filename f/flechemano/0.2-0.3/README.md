# Comparing `tmp/flechemano-0.2.tar.gz` & `tmp/flechemano-0.3.tar.gz`
...
## Comparing `flechemano-0.2.tar` & `flechemano-0.3.tar`
...
### Comparing `flechemano-0.2/PKG-INFO` & `flechemano-0.3/PKG-INFO`
...
### Comparing `flechemano-0.2/flechemano.egg-info/PKG-INFO` & `flechemano-0.3/flechemano.egg-info/PKG-INFO`
